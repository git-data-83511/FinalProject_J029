...
function Navbar() {
  ...
  // If user role is admin, return null (or render an alternative component)
  if (userRole === "ADMIN") {
    return null; // or return <AdminNavbar /> for an admin-specific navbar
  }

  // Main render function for the Navbar component
  return (
    <nav className="NavbarItems">
      <h1 className="navbar-logo">Journey On Train</h1>
